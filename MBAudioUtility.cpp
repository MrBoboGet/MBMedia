...
namespace MBMedia
{
	...
	void AudioMixer::RemoveIndex(size_t IndexToRemove)
	{
		...
		//TODO kan optimeras, sj�lva interfacen med
	...
	AudioBuffer AudioMixer::p_GetSourceData(size_t SourceIndex, size_t NumberOfSamples, size_t* OutRecievedSamples)
	{
		...
		//TODO kanske redundnat, inte s�ker p� om det ska kr�vas att man alltid har 0:at resten av inputen...
	...
	size_t AudioMixer::GetNextSamples(uint8_t* const* DataBuffer, size_t NumberOfSamples,size_t BufferSampleOffset)
	{
		...
		{
			//int f�tt n�gon data, skriver bara 0
	...
	{
		//returnar alltid alla samples �ven om dem inte finns sparade, kanske borde v�nta vem vet?
