...
namespace MBMedia
{
	enum class VideoFormat
	{
		...
		YUVJ440P,  ///< planar YUV 4:4:0 full scale (JPEG), deprecated in favor of AV_PIX_FMT_YUV440P and setting color_range
	...
	/**@{*/
	AV_PIX_FMT_VAAPI_MOCO, ///< HW acceleration through VA API at motion compensation entry-point, Picture.data[3] contains a vaapi_render_state struct which contains macroblocks as well a
	 ...
	 */
	 AV_PIX_FMT_VAAPI,
		...
		Y400A = YA8, ///< alias for AV_PIX_FMT_YA8
		GRAY8A = YA8, ///< alias for AV_PIX_FMT_YA8
		...
		*/
		...
		GBR24P = GBRP, // alias for #AV_PIX_FMT_GBRP
		...
		*/
		...
		YUVJ411P,    ///< planar YUV 4:1:1, 12bpp, (1 Cr & Cb sample per 4x1 Y samples) full scale (JPEG), deprecated in favor of AV_PIX_FMT_YUV411P and setting color_range
